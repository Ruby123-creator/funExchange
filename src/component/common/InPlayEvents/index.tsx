                ...
                <div
                    ...
                    <div className="eventHeadName grid grid-cols-12">
                        <div
                            ...
                            <span>
                                <BiSolidCricketBall fill="#8B191B" size={20}/>
                               </span>
                            <div
                        ...
                        {
                          (cricketEvents||[]).map((item: any,i: any)=>{
                                ...
                                <span
                                    ...
                                    <div
                                        className="w-full grid grid-cols-12 grid-flow-col overflow-auto h-full">
                                             <LayBack lay={item?.lay11} allowed={true} back={item?.back11} laycount={item?.lay1} backcount={item?.back1}/>
                                      <LayBack lay={'-'} back={'-'} allowed={true} laycount={''} backcount={''}/>
                                   
                                      <LayBack lay={item?.lay12} allowed={true} back={item?.back12} laycount={''} backcount={''}/>
