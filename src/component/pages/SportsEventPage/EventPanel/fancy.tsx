...
const FancyComp: React.FC = () => {
  ...
  return (
    <div> 
        {
            (data?.session||[])?.length ? <> <div className="text-base font-medium text-center py-1.5">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className=" w-full flex flex-nowrap gap-x-2"><span
                                    className=" truncate w-full capitalize text-text_Ternary  text-[13px] md:text-sm  font-semibold">
                                    {item?.RunnerName}</span></div><span
                            ...
                            className=" col-span-2 md:col-span-1 flex flex-row items-center justify-center gap-x-[2px]"><svg
                                ...
                                className=" font-[480] text-sm text-text_Ternary ">1s</span></span><span
        ...
        
                            {
                                ...
                                <span
                                    className=" col-span-6 text-center min-h-12 py-[1px] px-[1px]"><span
                                        className="  text-center bg-bg_ballRunning cursor-not-allowed w-full h-full rounded-sm flex text-xs flex-col items-center justify-center capitalize">{item?.GameStatus}</span></span>
                            </div>:<> 
                            
                            <span className=" text-center min-h-12 cols-span-1 md:col-span-2"
                            onClick={() => {
                                 setMatchedBets({ ...betOdds, odds: item?.BackPrice1 });
                              }}
                            ><span
