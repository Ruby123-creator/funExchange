    ...
    <div className="flex flex-col transition-all lg:pt-[110px] ease-in-out duration-100 pt-[94px]">
      ...
      <div className="w-full lg:w-[50%] px-2 py-4 pt-[18px] my-[13px] lg:pt-0 lg:my-0"
                        ...
                        <div className="flex flex-col h-full">
                            <div className="z-10">
                                <div className="undefined">
                                    <div className="w-full grid grid-cols-12 gap-3 p-3 bg-bg_Quaternary z-50 font-lato">
                                        ...
                                        <div
                                            className=" active:scale-95 col-span-2 bg-titleGrd p-2 rounded relative right-2 flex sm:items-center justify-center">
                                        ...
                                        <div
                                            className="col-span-12 text-xs sm:text-sm flex items-center gap-2 justify-center">
                                            <button
                            ...
                            <div
                                className=" w-full  min-h-[calc(100dvh-150px)]   flex items-center justify-center flex-col ">
                                <span>
                                <img src="icons/nofound.svg" alt="My Icon" width={400} height={400} />
                                </span>
                                <span className="text-text_Ternary  font-normal text-center">No data found for
