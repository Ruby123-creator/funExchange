...
const TransactionPage: React.FC = () => {
  ...
  return (
                        ...
                        <div className="no-scrollbar h-full overflow-y-auto">
                            <div className="px-2 w-full">
                                <div
                                    ...
                                    <div className="cursor-pointer flex flex-row items-center justify-center"><span
                                            className=" text-text_Quaternary  px-[25px] py-2  text-[13px] md:text-sm lg:text-base font-bold leading-4 active:scale-95 block z-10 ">Deposit</span>
                                    </div>
                                    <div className="cursor-pointer flex flex-row items-center justify-center"><span
                                            className=" text-text_Ternary bg-bg_Quaternary rounded-full border border-ternary6  px-[25px] py-2  text-[13px] md:text-sm lg:text-base font-bold leading-4 active:scale-95 block z-10 ">Withdrawal</span>
                                    </div>
                                    <div className="absolute z-1 w-full h-full transition-all ease-in-out duration-150 bg-bg_Primary text-sm bg-bg_Primary rounded-full border border-primary"
                                        style={{width: "102px", top: "1px", left: "0px", height: "40px"}}></div>
                                </div>
                            </div>
   ...
   suffixIcon={ <button
    ...
    type="button"><span
        className=" transform transition-transform duration-300  rotate-0"><FaAngleDown fill="var(--color-quaternary)" size={16}/> </span></button>}
    />
                                ...
                                <button
                                    ...
                                    type="button"><svg width="16" height="16" viewBox="0 0 24 24" fill="white"
                            ...
                            <div className=" rounded-lg flex flex-col gap-y-2 px-2 overflow-clip mt-2 font-lato">
                                <div className="flex justify-center items-center  sticky  top-12 ">
                                    <div
                                        className=" text-center bg-bg_Quaternary px-2.5 py-1 font-bold  rounded text-[10px]  shadow-sm">
                                        25/10/2024</div>
                                </div>
                                <div
                                    ...
                                    <div className="flex justify-between items-start text-[10px] font-bold h-full">
                                        ...
                                        <div
                                            className=" px-3 py-1 text-x xs:text-xs sm:text-sm font-semibold text-text_Quaternary rounded-bl h-full  bg-bg_transactionSuccessBg ">
                                            Approved</div>
                                    </div>
                                    <div className="flex px-3 justify-between"><span
                                            className="flex flex-col  justify-center"><span
                                                className="text-xs font-normal">#</span></span><span
                                            className="text-start text-lg font-roboto flex items-center tracking-tighter font-bold">₹
                                            2,000</span></div>
                                    <div
                                        className="text-xs py-1 text-center text-text_Quinary w-full border-t bg-bg_Ternary6">
                                        2024-10-25T13:53:31.973Z</div>
                                </div>
                                <div className="flex justify-center items-center  sticky  top-12 ">
                                    <div
                                        className=" text-center bg-bg_Quaternary px-2.5 py-1 font-bold  rounded text-[10px]  shadow-sm">
